	...
	<!-- <div class="middle py-5" id="facts">
		<div class="container pt-lg-3">
			<div class="welcome-left text-center py-md-5 py-3">
				...
				<a href="causes.php" class="btn btn-style btn-primary mt-sm-5 mt-4"><span class="fa fa-heart mr-1"></span> Donate Now</a>
			</div>
		</div>
	</div> -->
	<!-- //middle -->
          ...
          <div id="footers14-block">
              <div class="container">
                  ...
                  <div class="footers14-bottom d-flex justify-content-center">
                      <div class="copyright">
                          <!-- <p>© 2022 Save Poor. All rights reserved. Design by <a href="#"ftarget="_blank">Basil Pulikuth</a></p> -->
                      </div>                     
                  </div>
              </div>
          </div>
